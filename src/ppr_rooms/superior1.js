...
renderRoomPage({
	...
	heroImage:  { src: heroImg, alt: "Superior 1 living area, Penta P Residence, Ubon Ratchathani" },
	descriptionKeys: [
		"room.ppr.desc.1",
		"room.ppr.desc.2",
	],
	gallery: [
		{ src: img2, alt: "Superior 1 interior, Penta P Residence, Ubon Ratchathani", wide: true },
		{ src: img3, alt: "Superior 1 interior, Penta P Residence, Ubon Ratchathani" },
		{ src: img4, alt: "Superior 1 interior, Penta P Residence, Ubon Ratchathani" },
		{ src: img5, alt: "Superior 1 interior, Penta P Residence, Ubon Ratchathani" },
		{ src: img6, alt: "Superior 1 interior, Penta P Residence, Ubon Ratchathani" },
		{ src: img7, alt: "Superior 1 interior, Penta P Residence, Ubon Ratchathani" },
		{ src: img8, alt: "Superior 1 interior, Penta P Residence, Ubon Ratchathani" },
		{ src: img9, alt: "Superior 1 interior, Penta P Residence, Ubon Ratchathani", wide: true },
	],
	floorPlan: { src: imgPlan, alt: "Superior 1 floor plan, Penta P Residence, Ubon Ratchathani" },
	mapUrl:    PPR_MAP_URL,
	schema: {
		name:        "Superior 1",
